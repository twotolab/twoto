package {
	...
	public class ConnectorGoogleAnalytics extends Sprite {
		...
		public function ConnectorGoogleAnalytics() {
			...
			loader.load(new URLRequest("http://www.twoto.com/googleAnalytics/get_token.php?user=patrick@twoto.com&pass=h2o_001pulli"));
		...
		private function _onFeedLoaded(event:Event):void {
			...
			var rsult:String =getElt("pageviews") ;
			trace(">" + rsult+ "<");
		...
		private function getElt(actualValueType:String):String {
			...
			var eltString:String=dXMLList[0];
			return eltString;
