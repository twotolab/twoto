package
{
	...
	public class MoleculeBig extends AbstractCellsClass implements IContent{
		...
		private var attractionWidth:uint;
		private var attractionHeight:uint;
		...
		private var gridElements:uint;
		private var acceleration:Number;
		
		private var _naviColor:uint;
		
		public function MoleculeBig()
		{
		...
		private function addedToStage(evt:Event):void{
			...
			colorChoice= Math.random()*0xffffff;
			naviColor =colorChoice;
			friction = 0.04//0.02;
			...
			attractionWidth =240//180;
			attractionHeight =40//30;
			acceleration=.0007//.0009;
			...
			impactContainer = new Assets.Text() as Sprite;
			 ...
			 textF.scaleX=textF.scaleY=factor;
		...
		private function moveToCenter(partA:Ball):void{
			...
			var ax:Number =(partA.attractionPt.x-partA.x)*acceleration;
			var ay:Number =(partA.attractionPt.y-partA.y)*acceleration;
			partA.vx +=ax;
			partA.vy +=ay;
		}
		private function redrawSprites():void{
			...
			proximityManager = new ProximityManager(gridElements);
		...
		override public function get naviColor():uint{
			//trace("get _naviColor:"+_naviColor);
			return _naviColor;
		}
		override public function set naviColor(color:uint):void{
			//trace("set _navicolor:"+color);
			_naviColor =color;
