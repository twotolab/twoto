package com.twoto.submenu.ui
{
	...
	*/
	...
	public class SubMenuElement extends AbstractButton implements IButtons
	{
		//---------------------------------------------------------------------------
		// 	private variables
		//---------------------------------------------------------------------------
		...
		//---------------------------------------------------------------------------
		public function SubMenuElement(_text:String,_activ:Boolean = false,_secondLabel:String=null)
		{
			...
			this.activ = _activ;
			//
			/*textMask = Draw.drawShape(text.textWidth,text.textHeight,0.5,0xff0000,text.x,text.y);
		...
		//---------------------------------------------------------------------------
			...
			TweenLite.to(line, style.COLOR_TRANS_SPEED, {tint:style.menuColorStyle});
		}
		//---------------------------------------------------------------------------
