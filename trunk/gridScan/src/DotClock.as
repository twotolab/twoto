package {
	...
	public class DotClock extends AbstractContent implements IContent {
		//---------------------------------------------------------------------------
		// 	private variables
		//---------------------------------------------------------------------------
		...
		private var timeDotElement:DrawDotElement;
		...
		private static const TEXT_LINES_NUMBER:String=".created dots ";
		...
		public function DotClock() {
			...
			colorChoice=0xffffff; //cc3300;
			backGroundColor=0x00d2ff; //55002A;
			backGroundShadowColor=0x00d2ff;
			maxTextWidth=828;
			linecounter=0;
		...
		private function redrawTime(evt:DotsEvent=null):void {
			...
			if (clock != null) {
				...
				linecounter=0;
				timeDotElement=new DrawDotElement(generatedText(clock.actualTimeString, 0), colorChoice);
