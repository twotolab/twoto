package com.twoto.gridScanner {
	...
	public class DrawWithLineElement extends Sprite implements IBasics {
		//---------------------------------------------------------------------------
		// 	private variables
		//---------------------------------------------------------------------------
		...
		// 	constructor
		//---------------------------------------------------------------------------
		public function DrawWithLineElement(_targetContainer:Sprite, _colorChoice:int, _centerPt:Point) {
		...
		public function drawPoint(pt:Point):void {
			...
			shape.graphics.lineStyle(0, colorChoice, 0.05);
			//trace("pt :"+pt)
