package com.twoto.utils {
	...
	public dynamic class Draw {
		...
		//--createShape-------------------------------------------------------------------------------------------------
		public static function ShapeElt(_width:int=100, _height:int=100, _alpha:Number=1, _color:Number=0xff0000, _x:int=0, _y:int=0):Shape {
			var square:Shape=new Shape();
			square.graphics.beginFill(_color, _alpha);
		...
		//--ShapeLineElt-------------------------------------------------------------------------------------------------
		public static function ShapeLineElt(_width:int=100, _height:int=100,_thickness:Number=1, _alpha:Number=1, _color:Number=0xff0000, _x:int=0, _y:int=0):Shape {
			var square:Shape=new Shape();
			square.graphics.lineStyle(_thickness,_color,_alpha);
			square.graphics.beginFill(_color, 0);
			square.graphics.drawRect(_x, _y, _width, _height);
			square.graphics.endFill();
			return square;
		}
		...
		//--createSprite-------------------------------------------------------------------------------------------------
		public static function SpriteElt(_width:int=100, _height:int=100, _alpha:Number=1, _color:Number=0xff0000, _x:int=0, _y:int=0):Sprite {
		...
		//--dottedLine-------------------------------------------------------------------------------------------------
		public static function dottedLine(x:int, y:int, _width:uint, _color:uint=0xff0000):Shape {
			//
			...
			while (count <= _width) {
				shape.graphics.drawRect(count, 0, 1, 1);
				count=count + 2;
			}
