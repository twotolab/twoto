package {
	...
	public class Dot2Clock extends AbstractContent implements IContent {
		//---------------------------------------------------------------------------
		// 	private variables
		//---------------------------------------------------------------------------
		...
		// 	constructor
		//---------------------------------------------------------------------------
		public function Dot2Clock() {

			colorChoice=0xffffff;
			color2Choice=0xdc03b1; //cc3300;
		...
		private function redrawTime(evt:DotsEvent=null):void {
			...
			if (clock != null) {
				...
				timeDotElement=new DrawDotElement(generatedText(clock.actualTimeString, 0), colorChoice,color2Choice);
